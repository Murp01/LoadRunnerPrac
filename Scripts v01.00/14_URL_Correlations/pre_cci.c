# 1 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\14_url_correlations\\\\combined_14_URL_Correlations.c"
...
# 1 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\14_url_correlations\\\\combined_14_URL_Correlations.c" 2
...
# 2 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\14_url_correlations\\\\combined_14_URL_Correlations.c" 2
...
# 3 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\14_url_correlations\\\\combined_14_URL_Correlations.c" 2
...
# 4 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\14_url_correlations\\\\combined_14_URL_Correlations.c" 2
...
Action()
{
	...
	lr_end_transaction("Click login button",2);
	...
	web_reg_save_param_ex(
		"ParamName=param_SessionKey",
		"LB=href=\"http://localhost/moodle/login/logout.php?sesskey=",
		"RB=\"",
		"SEARCH_FILTERS",
		"LAST");
	...
	lr_end_transaction("Log in as teacher",2);
	...
	lr_end_transaction("Click on Course",2);

	lr_start_transaction("Log out as teacher1");

	web_url("Logout",
		"URL=http://localhost/moodle/login/logout.php?sesskey={param_SessionKey}",
		"Resource=0",
		"RecContentType=text/html",
	...
	lr_end_transaction("Log out as teacher1",2);

	return 0;
}
# 5 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\14_url_correlations\\\\combined_14_URL_Correlations.c" 2
...
# 6 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\14_url_correlations\\\\combined_14_URL_Correlations.c" 2
