# 1 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\09_selectcourse_paramselect\\\\combined_09_SelectCourse_ParamSelect.c"
...
# 1 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\09_selectcourse_paramselect\\\\combined_09_SelectCourse_ParamSelect.c" 2
...
# 2 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\09_selectcourse_paramselect\\\\combined_09_SelectCourse_ParamSelect.c" 2
...
# 3 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\09_selectcourse_paramselect\\\\combined_09_SelectCourse_ParamSelect.c" 2
...
# 4 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\09_selectcourse_paramselect\\\\combined_09_SelectCourse_ParamSelect.c" 2
...
Action()
{
	...
	web_add_cookie("MS-CV=jKM0XaJvlkuXca1h.1; DOMAIN=c.urs.microsoft.com");
	...
	web_url("moodle", 
		...
		"Url=https://c.urs.microsoft.com/l1.dat?cw=636522320666711122&v=3&cv=9.11.16299.0&os=10.0.16299.0.0&pg=4A72F430-B40C-4D36-A068-CE33ADA5ADF9", "Referer=", "ENDITEM", 
		"LAST");
	...
	web_add_cookie("MS-CV=jKM0XaJvlkuXca1h.1; DOMAIN=iecvlist.microsoft.com");
	...
	lr_end_transaction("Trans_Login",2);

	lr_start_transaction("trans_login_credentials");
	...
	lr_end_transaction("trans_login_credentials",2);

	lr_think_time(48);

	lr_start_transaction("trans_select_course");

	web_link("Test Course{param_randomCourse}", 
		"Text=Test Course{param_randomCourse}", 
		"Snapshot=t5.inf", 
		"EXTRARES", 
		"Url=../theme/image.php/afterburner/core/1409244180/t/expanded", "Referer=http://localhost/moodle/course/view.php?id={param_randomCourse}", "ENDITEM", 
		"Url=../theme/yui_combo.php?3.5.1/build/attribute-core/attribute-core-min.js&3.5.1/build/base-core/base-core-min.js&3.5.1/build/event-custom-complex/event-custom-complex-min.js&3.5.1/build/attribute-events/attribute-events-min.js&3.5.1/build/attribute-extras/attribute-extras-min.js&3.5.1/build/attribute-base/attribute-base-min.js&3.5.1/build/base-base/base-base-min.js&3.5.1/build/base-pluginhost/base-pluginhost-min.js&3.5.1/build/base-build/base-build-min.js&3.5.1/build/event-synthetic/"
		"event-synthetic-min.js&3.5.1/build/event-mouseenter/event-mouseenter-min.js&3.5.1/build/event-resize/event-resize-min.js&moodle/1409244180/block_navigation/navigation/navigation.js", "Referer=http://localhost/moodle/course/view.php?id={param_randomCourse}", "ENDITEM", 
		"LAST");

	lr_end_transaction("trans_select_course",2);

	lr_start_transaction("trans_logout");
	...
	lr_end_transaction("trans_logout",2);

	return 0;
}
# 5 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\09_selectcourse_paramselect\\\\combined_09_SelectCourse_ParamSelect.c" 2
...
# 6 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\09_selectcourse_paramselect\\\\combined_09_SelectCourse_ParamSelect.c" 2
