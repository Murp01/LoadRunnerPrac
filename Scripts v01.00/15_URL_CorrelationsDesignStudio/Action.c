...
/*Correlation comment - Do not change!  Original value='PKz6GpEela' Name ='param_SessKeyDS' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
		"ParamName=param_SessKeyDS",
	...
	web_url("Logout",
		"URL=http://localhost/moodle/login/logout.php?sesskey={param_SessKeyDS}",
		"Resource=0",
		"RecContentType=text/html",
