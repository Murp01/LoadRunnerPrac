# 1 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\17_url_capturingdynamicvariablesinparam2\\\\combined_17_URL_CapturingDynamicVariablesInParam2.c"
...
# 1 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\17_url_capturingdynamicvariablesinparam2\\\\combined_17_URL_CapturingDynamicVariablesInParam2.c" 2
...
# 2 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\17_url_capturingdynamicvariablesinparam2\\\\combined_17_URL_CapturingDynamicVariablesInParam2.c" 2
...
# 3 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\17_url_capturingdynamicvariablesinparam2\\\\combined_17_URL_CapturingDynamicVariablesInParam2.c" 2
...
# 4 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\17_url_capturingdynamicvariablesinparam2\\\\combined_17_URL_CapturingDynamicVariablesInParam2.c" 2
...
Action()
{
	...
	lr_end_transaction("Click Login",2);
	...
	for (i = 2; i <= atoi(lr_eval_string("{param_CountryList_count}")); i++){
		sprintf(p_country, "{param_CountryList_%d}", i);
		lr_output_message(lr_eval_string(p_country));
	                     }

	lr_end_transaction("Click Create new account",2);
	...
	lr_end_transaction("Submite new account details",2);
...
# 5 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\17_url_capturingdynamicvariablesinparam2\\\\combined_17_URL_CapturingDynamicVariablesInParam2.c" 2
...
# 6 "c:\\users\\paul\\documents\\vugen\\scripts v01.00\\17_url_capturingdynamicvariablesinparam2\\\\combined_17_URL_CapturingDynamicVariablesInParam2.c" 2
